...
class save implements Serializable
{
	...
	public LinkedList<Double> zombiex = new LinkedList<Double>();
	public LinkedList<Double> zombiey = new LinkedList<Double>();
	public LinkedList<Integer> zombiec = new LinkedList<Integer>();
	public LinkedList<Double> plantx = new LinkedList<Double>();
	public LinkedList<Double> planty = new LinkedList<Double>();
	public LinkedList<Integer> plantc = new LinkedList<Integer>();
	
	public int suncounter = 0;
	save(LinkedList<Double> arrx,LinkedList<Double> arry,int ss,LinkedList<Integer> arrc,LinkedList<Double> arrpx,LinkedList<Double> arrpy,LinkedList<Integer> arrpc){
		zombiex = arrx;
		zombiey = arry;
		zombiec = arrc;
...
public class LawnController implements Initializable{
	...
	private LinkedList<plant> arrpl = new LinkedList<plant>();
...
//		ImageView p1 = new ImageView("sunflower.gif");
		...
		arrpx.add(event.getSceneX());
		arrpy.add(event.getSceneY());
		arrpc.add(0);
...
//							fulltm.stop();
	...
	private void savegame(ActionEvent event) {
		LinkedList<Double> zombiex = new LinkedList<Double>();
		LinkedList<Double> zombiey = new LinkedList<Double>();
		LinkedList<Integer> zombiec = new LinkedList<Integer>();
		
		for(zombie jj : arrl) {
			zombiex.add(jj.cord_x);
			zombiey.add(jj.cord_y);
			zombiec.add(jj.zop);
		}
		save s1 = new save(zombiex,zombiey,Integer.parseInt(suncounter.getText()),zombiec,arrpx,arrpy,arrpc);
		try
	        {    
	            FileOutputStream file = new FileOutputStream(user.name); 
...
//		suncounter.setText("100");
	...
	private LinkedList<Double> arrpx = new LinkedList<Double>();
	private LinkedList<Double> arrpy = new LinkedList<Double>();
	private LinkedList<Integer> arrpc = new LinkedList<Integer>();
	...
	public void initialize(URL url, ResourceBundle rb) {
        ...
        {    
            ...
            s1 = (save)in.readObject(); 
              
            in.close(); 
            file.close(); 
            for(int i = 0;i<s1.zombiex.size();i++) {
            	zombie zz = new zombie(s1.zombiex.get(i),s1.zombiey.get(i),stackpane,arrl,s1.zombiec.get(i));
            }
            suncounter.setText(Integer.toString(s1.suncounter));
            
            for(int i = 0;i<s1.plantc.size();i++) {
            	if(s1.plantc.get(i)==0) {
            		sunflower ss = new sunflower(s1.plantx.get(i),s1.planty.get(i),stackpane,suncounter);
            	}
            	else if(s1.plantc.get(i)==1) {
            		peashooter ss = new peashooter(s1.plantx.get(i),s1.planty.get(i),stackpane,arrl,suncounter);
            	}
            }
